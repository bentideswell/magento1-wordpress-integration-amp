...
class Fishpig_Wordpress_Addon_AMP_Helper_Core extends Mage_Core_Helper_Abstract
{
	/**
	...
	public function __construct()
	{
		...
		try {
			...
			// Apply file patches
			if (false) {
				if ($patches = Mage::getConfig()->getNode('wordpress/core/modules/{{MODULE-ALIAS}}/patch')) {
